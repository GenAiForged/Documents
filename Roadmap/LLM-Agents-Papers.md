# LLM-Powered Agents: Comprehensive Paper Collection
...
- **CoALA** - Cognitive Architectures for Language Agents (Sumers et al., 2023)
  - Specifies agent action space, decision making, and memory systems
  - Distinguishes between external actions (grounding) and internal actions (reasoning, retrieval, learning)
...
- LLM+P - Empowering LLMs with Optimal Planning Proficiency
- LLM-Deliberation - Multi-Agent Negotiation Games
...
## Research Directions
- Safety and alignment of agents
